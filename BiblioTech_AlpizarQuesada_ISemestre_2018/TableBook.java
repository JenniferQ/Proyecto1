...
public class TableBook extends javax.swing.JFrame {
    ...
    public TableBook() throws IOException, FileNotFoundException, ClassNotFoundException {
        initComponents();
        this.setExtendedState(TableBook.MAXIMIZED_BOTH);
          ArrayList();
    }

    public void ArrayList() throws IOException, FileNotFoundException, ClassNotFoundException {
        DefaultTableModel medel = (DefaultTableModel) tableBooks.getModel();
        File archivo = new File("Books.dat");

        MaterialFile material = new MaterialFile(archivo);
        ArrayList<Books> book = material.getBookList();
        Object Book[] = new Object[7];
        for (int i = 0; i < book.size(); i++) {
            Book[0] = book.get(i).getYear();
            Book[1] = book.get(i).getAuthor();
            Book[2] = book.get(i).getFormat();
            Book[3] = book.get(i).getName();
            Book[4] = book.get(i).getCode();
            Book[5] = book.get(i).getQuantity();
            Book[6] = book.get(i).getAvailable();
            medel.addRow(Book);
    ...
    private void initComponents() {
        ...
        tableBooks.setBackground(new java.awt.Color(240, 240, 240));
        tableBooks.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Year", "Author", "Format", "Name", "Code", "Quantity", "Available"
            }
        ) {
        ...
        tableBooks.setShowHorizontalLines(false);
        tableBooks.setShowVerticalLines(false);
        ...
        if (tableBooks.getColumnModel().getColumnCount() > 0) {
            ...
            tableBooks.getColumnModel().getColumn(6).setResizable(false);
        }

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(320, 180, 1190, 570);
    ...
    private void menuItemRegisterStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemRegisterStudentActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TableBook.class.getName()).log(Level.SEVERE, null, ex);
        }
