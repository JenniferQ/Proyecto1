...
public class LoanRegister extends javax.swing.JFrame {
    ...
    public LoanRegister() {
        initComponents();
        btn_loanAudiuvisual.setEnabled(false);
        btn_loanBook.setEnabled(false);
        archivo = new File("Student.dat");
        this.setExtendedState(LoanRegister.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        lb_veryStudent = new javax.swing.JLabel();
        tf_verifyStudent = new javax.swing.JTextField();
        btn_verifyStudent = new javax.swing.JButton();
        btn_loanAudiuvisual = new javax.swing.JButton();
        btn_loanBook = new javax.swing.JButton();
        lb_nameStudentVerify = new javax.swing.JLabel();
        ...
        lb_veryStudent.setFont(new java.awt.Font("Sitka Small", 1, 22)); // NOI18N
        lb_veryStudent.setText("Id");
        getContentPane().add(lb_veryStudent);
        lb_veryStudent.setBounds(380, 300, 25, 29);

        tf_verifyStudent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tf_verifyStudentActionPerformed(evt);
            }
        });
        getContentPane().add(tf_verifyStudent);
        tf_verifyStudent.setBounds(500, 290, 370, 40);

        btn_verifyStudent.setFont(new java.awt.Font("Sitka Small", 1, 22)); // NOI18N
        btn_verifyStudent.setText("Verify");
        btn_verifyStudent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_verifyStudentActionPerformed(evt);
            }
        });
        getContentPane().add(btn_verifyStudent);
        btn_verifyStudent.setBounds(800, 460, 107, 37);

        btn_loanAudiuvisual.setFont(new java.awt.Font("Sitka Small", 1, 22)); // NOI18N
        btn_loanAudiuvisual.setText("Audivisual");
        btn_loanAudiuvisual.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_loanAudiuvisualActionPerformed(evt);
            }
        });
        getContentPane().add(btn_loanAudiuvisual);
        btn_loanAudiuvisual.setBounds(630, 700, 159, 37);

        btn_loanBook.setFont(new java.awt.Font("Sitka Small", 1, 22)); // NOI18N
        btn_loanBook.setText("Book");
        btn_loanBook.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_loanBookActionPerformed(evt);
            }
        });
        getContentPane().add(btn_loanBook);
        btn_loanBook.setBounds(970, 700, 145, 37);
        getContentPane().add(lb_nameStudentVerify);
        lb_nameStudentVerify.setBounds(275, 155, 573, 37);
    ...
    private void tf_verifyStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_verifyStudentActionPerformed
        //si.setText("");
    }//GEN-LAST:event_tf_verifyStudentActionPerformed

    private void btn_verifyStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_verifyStudentActionPerformed
       
                    st = new StudentFile("Student.dat");
        try {
            if (st.verify(tf_verifyStudent.getText())) {

                btn_loanAudiuvisual.setEnabled(true);
                btn_loanBook.setEnabled(true);

            } else {
                btn_loanAudiuvisual.setEnabled(false);
                btn_loanBook.setEnabled(false);
                lb_veryStudent.setText("Debe estar registrado en el sistema");
            }
        } catch (IOException ex) {
            Logger.getLogger(LoanRegister.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(LoanRegister.class.getName()).log(Level.SEVERE, null, ex);
        }

    }//GEN-LAST:event_btn_verifyStudentActionPerformed

    private void btn_loanAudiuvisualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loanAudiuvisualActionPerformed
        LoanAudiovisual la;
        try {
            la = new LoanAudiovisual();
            la.setVisible(true);
    ...
    }//GEN-LAST:event_btn_loanAudiuvisualActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoanRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoanRegister().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btn_loanAudiuvisual;
    private javax.swing.JButton btn_loanBook;
    private javax.swing.JButton btn_verifyStudent;
    private javax.swing.JMenuBar jMenuBar1;
    private javax.swing.JLabel lb_image;
    private javax.swing.JLabel lb_nameStudentVerify;
    private javax.swing.JLabel lb_veryStudent;
    ...
    private javax.swing.JTextField tf_verifyStudent;
