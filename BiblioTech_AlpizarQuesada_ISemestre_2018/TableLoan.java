 ...
 * @author jenny
 */
public class TableLoan extends javax.swing.JFrame {

    File archiviLoan;

    public TableLoan() throws IOException, FileNotFoundException, ClassNotFoundException {
        initComponents();
        ArrayList();
    ...
    public void ArrayList() throws IOException, FileNotFoundException, ClassNotFoundException {
        ...
        DefaultTableModel medel = (DefaultTableModel) tableLoan.getModel();
        archiviLoan = new File("Loan.dat");
        LoanFile loanFile = new LoanFile(archiviLoan);
        ArrayList<Loan> loan = loanFile.getLoanList();
        Object Audiovisual[] = new Object[4];
        for (int i = 0; i < loan.size(); i++) {
            Audiovisual[0] = loan.get(i).getNameStudent();
            Audiovisual[1] = loan.get(i).getId();
            Audiovisual[2] = loan.get(i).getCode();
            Audiovisual[3] = loan.get(i).getFechaSolicitud();
    ...
    private void initComponents() {
        ...
        tableLoan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name Student", "Id", "Code", "Date Loan"
            }
        ) {
    ...
    private void menuItemRegisterStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemRegisterStudentActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TableLoan.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableLoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
