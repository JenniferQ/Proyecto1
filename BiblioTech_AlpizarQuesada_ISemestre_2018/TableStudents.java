...
public class TableStudents extends javax.swing.JFrame {
  

   
    public TableStudents() throws IOException, FileNotFoundException, ClassNotFoundException {
        initComponents();
       
       ArrayList();
        this.setExtendedState(TableStudents.MAXIMIZED_BOTH);
        
    }
  public void ArrayList() throws IOException, FileNotFoundException, ClassNotFoundException {
        DefaultTableModel medel = (DefaultTableModel) tableStudent.getModel();


         StudentFile studentFile = new StudentFile("Student.dat");
        ArrayList<Student> student = studentFile.getListStudent();
        Object Student[] = new Object[7];
        for (int i = 0; i < student.size(); i++) {
            Student[0] = student.get(i).getName();
            Student[1] = student.get(i).getId();
            Student[2] = student.get(i).getCareer();
            Student[3] = student.get(i).getYear();
            Student[4] = student.get(i).getCel();
            Student[5] = student.get(i).getMail();
            Student[6] = student.get(i).getDirection();
            medel.addRow(Student);
    ...
    private void menuItemRegisterStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemRegisterStudentActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TableStudents.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableStudents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    new TableStudents().setVisible(true);
                } catch (IOException | ClassNotFoundException ex) {
                    Logger.getLogger(TableStudents.class.getName()).log(Level.SEVERE, null, ex);
                }
