...
public class About extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setFont(new java.awt.Font("Sitka Small", 0, 22)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("Intellect Liblary:\n\nIt is a desktop application designed to organize\nand maintain the relevant data of the library up to date. \nSuch as: registration and loans of students, audiovisual \nand books.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(546, 184, 741, 223);
